...
} from "@DAL/server-requests/dataAggregation";
...
const ExperimentsList = ({
  ...
  const areExperimentsModified =
    Object.values(modifiedExperiments).length !== 0;
      ...
      <Dialog open={openShareDialog} onClose={() => setOpenShareDialog(false)}>
        <DialogContent>
          <Typography variant="body1" color="textPrimary" gutterBottom>
            For sharing your experiment with participants, send them the
            following link:
          </Typography>
          <TextField
            fullWidth
