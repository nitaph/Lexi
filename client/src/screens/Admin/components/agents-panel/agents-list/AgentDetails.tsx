  ...
  <Grid container spacing={2} style={{ padding: "20px", paddingTop: "4px" }}>
    <Grid item xs={12} md={6} style={{ borderRight: "2px solid #eee" }}>
      ...
      <List>
        <ListItem>
          <ListItemText
            primary="First Chat Sentence"
            secondary={agent.firstChatSentence}
          />
        </ListItem>
        <ListItem>
        ...
        {agent.systemStarterPrompt && (
          <ListItem>
            <ListItemText
              primary="System Starter Prompt"
              secondary={agent.systemStarterPrompt}
            />
          </ListItem>
        )}
      ...
      <List style={{ paddingLeft: "24px" }}>
        <ListItem>
          <ListItemText
            primary="Temperature"
            secondary={
              agent.temperature !== null ? agent.temperature : "Not Active"
            }
          />
        </ListItem>
        ...
        <ListItem>
          <ListItemText
            primary="Max Tokens"
            secondary={
              agent.maxTokens !== null ? agent.maxTokens : "Not Active"
            }
          />
        </ListItem>
        <ListItem>
          <ListItemText
            primary="Top P"
            secondary={agent.topP !== null ? agent.topP : "Not Active"}
          />
        </ListItem>
        <ListItem>
          <ListItemText
