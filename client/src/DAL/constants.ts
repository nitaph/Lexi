import { AgentType, FormType, MultiAgentType } from "@models/AppModels";
...
// ✅ New default for multiAgents, used if needed
export const defaultMultiAgents: MultiAgentType[] = [
  { agent: "", dist: 50 },
  { agent: "", dist: 50 },
];
...
export const defaultExperiment = {
  ...
  displaySettings: {
    ...
    welcomeContent:
      "This is an experiment that is being carried out by Copenhagen Business School.\nHere you will take a short survey and then a creativity task with the collaboration of a chat bot.\nThe conversation is completely anonymous.\nFeel free to share as you like.",
  },
  experimentForms: {
    registration: null,
