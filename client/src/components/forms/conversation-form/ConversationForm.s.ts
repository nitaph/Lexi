// src/components/forms/conversation-form/ConversationForm.s.ts
import { IsMobile } from "@models/StylesModels";
import { Box, Grid, Typography } from "@mui/material";
import { styled } from "@mui/material/styles";

export const ConversationFormContainer = styled(Box, {
...
export const ConversationFormFieldTitle = styled(Typography, {
  shouldForwardProp: (prop) => prop !== "isMobile",
})<IsMobile>(({ isMobile }) => ({
