...
const App: FC = () => {
  ...
  const [openEndConversationDialog, setOpenEndConversationDialog] =
    useState(false);
        ...
        {isLoading ? (
          ...
          <Routes>
            ...
            >
              ...
              <Route
                path={Pages.EXPERIMENT_CONVERSATION.replace(
                  `${Pages.EXPERIMENT}/`,
                  "",
                )}
                element={
            ...
            <Route
              ...
              element={
                <Navigate
                  to={
                    activeUser?.isAdmin ? Pages.ADMIN : Pages.PROJECT_OVERVIEW
                  }
                  replace
                />
              }
